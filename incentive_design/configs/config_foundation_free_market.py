...
def get_config():
    ...
    config.agent.entropy_coeff = 0.187
    ...
    config.agent.lr_actor = 7.85e-4
    config.agent.lr_v = 1.74e-4
    config.agent.ppo_epsilon = 0.2197
    config.agent.share_parameter = True
    config.agent.tau = 0.114
    ...
    config.main.dir_name = '15x15_phase1_free_market'
