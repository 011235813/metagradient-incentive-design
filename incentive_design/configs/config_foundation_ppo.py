...
def get_config():
    ...
    config.agent.entropy_coeff = 0.184
    ...
    config.agent.lr_actor = 0.00033
    config.agent.lr_v = 1.67e-5
    config.agent.minibatch_size = 20
    config.agent.ppo_epsilon = 0.01
    config.agent.share_parameter = True
    config.agent.tau = 0.0126
    ...
    config.designer_m.lr_incentive = 1.82e-5
    config.designer_m.lr_v = 0.000864
    config.designer_m.pipeline = True
    config.designer_m.ppo_epsilon = 0.382
    config.designer_m.r_scalar = 1e-2
    config.designer_m.tau = 0.0158
    ...
    config.main.dir_name = '15x15_nocurr_m1'
