...
def get_config():
    ...
    config.agent.entropy_coeff = 0.253
    ...
    config.agent.lr_actor = 0.000139
    config.agent.lr_v = 5e-5
    config.agent.minibatch_size = 20
    config.agent.ppo_epsilon = 0.166
    config.agent.share_parameter = True
    config.agent.tau = 0.00436
    ...
    config.alg.train_phase2_without_restoring = True  # must be False if resume_phase2=True
    ...
    config.designer_m.lr_incentive = 2.03e-4
    config.designer_m.lr_v = 1.0e-5
    ...
    config.main.dir_name = '15x15_nocurr_us_federal'
    config.main.dir_restore = '15x15_ppo_phase1_0'
    config.main.exp_name = 'foundation'
    config.main.max_to_keep = 10
    config.main.meas_income_during_train = True
    ...
    config.nn_designer.use_lstm_actor = False
    config.nn_designer.use_lstm_critic = False
